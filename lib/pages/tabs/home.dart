...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    controller.fetchUserDetails().then((_) {
      if (controller.adminContactName.value.isNotEmpty &&
          controller.adminContactPhone.value.isNotEmpty) {
  ...
  void _showAdminContactDialog() {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        title: Text("Volunteer Contact Info"),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            Text("Name: ${controller.adminContactName.value}"),
            SizedBox(height: 8),
            Text("Phone: ${controller.adminContactPhone.value}"),
          ],
        ),
        actions: [
          TextButton(
